package com.ventus.ibs.gui.sample.samplenew;
...
import com.ventus.ibs.gui.interf.SampleContract;
import com.ventus.ibs.gui.sample.SampleAdapter;
...
public class SampleActivityNew extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, SampleContract.View {

    private static final String TAG = "SampleActivityNew";
