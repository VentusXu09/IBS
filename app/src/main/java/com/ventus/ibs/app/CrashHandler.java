...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                Toast.makeText(mContext, "abnormal termination of program, logs in /Documents/IBS/Log", Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }.start();
...
//                File dir1 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), mContext.getString(R.string.app_dir_name));
                File dir1 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), "IBS");
